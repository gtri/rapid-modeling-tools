...
class TestVertex(unittest.TestCase):
    ...
    def test_connections(self):
        ...
        vertex_1_connections = [
            ...
            {"source": "engine", "target": "Car", "edge_attribute": "type"},
        ]
        ...
        assert (
            Test_Graph.nodes["engine"]["engine"].connections
            == vertex_2_connections
        )
    ...
    def test_create_node_to_uml(self):
        ...
        engine_uml = vertex_engine.create_node_to_uml(translator=translator)
    ...
    def test_change_node_to_uml(self):
        ...
        rename_json = vertex_car.change_node_to_uml(translator=translator)
    ...
    def test_delete_node_to_uml(self):
        ...
        delete_json = vertex_car.delete_node_to_uml(translator=translator)
